...
## 9. Transaction Detail Display

### 9.1 Transaction Detail Modal

The approval code must be visible in the Transaction Detail Modal accessible from the Transaction Menu.

### 9.2 Single Payment Display

**Location:** Payment Info section after "Change" field
...
### 9.3 Split Payment Display

**Location:** Payment Breakdown section, indented under each card payment
...
| Scenario | Display |
|----------|---------|
| Single card payment | Show approval code and card last 4 |
| Single cash payment | No approval code |
| Split + card payment | Show approval code per card payment |
| Split + cash payment | No approval code for cash |
| No approval code | Don't show field |
...
| `apps/web/src/pages/Transactions.tsx` | Modified | Display approval code in transaction detail |
...
- `apps/web/src/pages/Transactions.tsx` (transaction detail display)
...
- [ ] Transaction detail shows approval code (single payment)
- [ ] Transaction detail shows approval code (split payment)
- [ ] Transaction detail doesn't show approval code for cash
...
| 1.1 | 2026-02-04 | Implemented - added approval code input for card payments, split payment support, receipt printing |
| 1.2 | 2026-02-04 | Added transaction detail display requirement for approval code |
| 1.3 | 2026-02-04 | Completed - transaction detail modal now shows approval code for single and split payments |
