...
| Scenario | Method | Who |
|----------|--------|-----|
| Manual creation at POS | Staff creates manually | Cashier/Manager |
...
| Permissions | vouchers:create, vouchers:read, vouchers:use, vouchers:void | ✅ Done | `packages/shared/src/constants/permissions.ts` |
