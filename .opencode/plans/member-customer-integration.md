# Feature: Member Customer Integration for POS
...
**Customer Groups:**
- Bronze (default), Silver, Gold, VIP tiers
- Used for segmentation, NOT for pricing
...
├─────────────────────────────────────────┤
│ ☑ SAVE10 - 10% off           [Apply]   │  ← Percentage discount
│ ☑ GIFTCARD50 - Balance: $50   [Apply]   │  ← Gift card
│ ☑ BUY1GET1 - Free item        [Apply]   │  ← BOGO
└─────────────────────────────────────────┘
```

**Voucher Application:**
- Applied at checkout via VoucherEntryModal
...
│ ─────────────────────────────────────────│
│ Vouchers Applied:                       │
│ ☑ SAVE10 (10% off)            -$7.60    │ ← Voucher discount
│ ─────────────────────────────────────────│
│ Subtotal:                              $75.97│
│ Discount:                              $7.60 │
│ Tax (10%):                            $6.84 │
...
#### Phase 1: Database & Sync (Offline Support)
| File | Change |
|------|--------|
...
#### Phase 2: Customer Lookup Service
| File | Change |
|------|--------|
| `apps/web/src/services/customer.ts` | Hybrid online/offline lookup |
...
|---------|------|---------|
| 1.0 | 2026-02-04 | Initial plan - member pricing included |
| 1.1 | 2026-02-04 | Simplified - no member pricing, all members eligible |
